...
const UploadDocumentScreen = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.heading}>Upload Screenshot of WhatsApp status for Verification</Text>
             <Text style={styles.subText}>Please upload a Screenshot of WhatsApp status to verify your status .</Text>
            <Text style={styles.subText}>In your status must have at least 50 Views .</Text>
            ...
            <TouchableOpacity style={styles.uploadCard} onPress={() => setModalVisible(true)}>
                {image ? (
                    ...
                    <>
                        ...
                        <Text style={styles.uploadText}>Choose a image and upload here</Text>
            ...
            <TouchableOpacity style={styles.closeIcon} onPress={() => setModalVisible(false)}>
                <Ionicons name="close" size={28} color="#000" />
                        ...
                        <View style={styles.modalOptions}>
                            ...
                            <TouchableOpacity style={styles.optionBtn} onPress={() => openPicker('gallery')}>
