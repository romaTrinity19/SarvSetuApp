      ...
      <View style={styles.container}>
        ...
        >
          ...
          <Text style={styles.sectionText}>
            ...
            products for modern consumers. What started as a small online shop
            has grown into a full-fledged eCommerce platform that brings
            customers closer to the things they love.
            {"\n\n"}
          ...
          <Text style={styles.sectionText}>
            - <Text style={styles.bold}>Wide Selection:</Text> We offer a
            diverse range of products to meet all your needs.{"\n"}-{" "}
          ...
          <Text style={styles.sectionText}>
            ...
            <Text style={styles.bold}>{companyName}</Text> ({founderName}) is
            your destination for quality. Thank you for choosing us — we can’t
            wait to serve you!
          </Text>
